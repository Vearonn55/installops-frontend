...
profilePage: {
  ...
  issuesPage: {
    ...
    manager: {
      ...
      pickInstallation: 'Choose an installation from your store',
      loadingInstallations: 'Loading installations…',
      noInstallations: 'No installations found for your store.',
      noStore: 'Your account is not linked to a store. Contact an administrator.',
      changeInstallation: 'Choose a different installation',
    },
    admin: {
