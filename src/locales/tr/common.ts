...
profilePage: {
  ...
  issuesPage: {
    ...
    manager: {
      ...
      pickInstallation: 'Mağazanızdan bir kurulum seçin',
      loadingInstallations: 'Kurulumlar yükleniyor…',
      noInstallations: 'Mağazanız için kurulum bulunamadı.',
      noStore: 'Hesabınız bir mağazaya bağlı değil. Yönetici ile iletişime geçin.',
      changeInstallation: 'Başka kurulum seç',
    },
    admin: {
